...
class FIDCalculator:
    ...
    def extract_features_from_generator(self, generator, num_samples=50000, batch_size=50, latent_dim=100, device=None):
        """
    ...
    def calculate_fid(self, real_dataloader, generator, num_samples=50000, batch_size=50, latent_dim=100):
        """
