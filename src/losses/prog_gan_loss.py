"""
Wasserstein GAN with Gradient Penalty Loss Functions compatiable with Progressive GANs.
...
class ProgGANGPLoss(WGANLoss):
    ...
    def gradient_penalty(
        ...
        d_interpolates = discriminator(interpolates, current_res=current_res, alpha=alpha)
