...
def get_dataset(config):
    ...
    if dataset_name == "mnist":
        dataset = datasets.MNIST(root="./data/downloaded", train=True, download=True, transform=transform)
    elif dataset_name == "fashion_mnist":
        dataset = datasets.FashionMNIST(root="./data/downloaded", train=True, download=True, transform=transform)
    elif dataset_name == "cifar10":
        dataset = datasets.CIFAR10(root="./data/downloaded", train=True, download=True, transform=transform)
        ...
        dataset = datasets.CelebA(root="./data/downloaded", split="train", download=True, transform=transform)
